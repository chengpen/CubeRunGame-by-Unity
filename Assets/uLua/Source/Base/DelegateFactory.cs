...
public static class DelegateFactory
{
	...
	public static void Register(IntPtr L)
	{
		...
		dict.Add(typeof(UILabel.ModifierFunc), new DelegateValue(UILabel_ModifierFunc));
	...
	public static Delegate UILabel_ModifierFunc(LuaFunction func)
	{
		UILabel.ModifierFunc d = (param0) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
