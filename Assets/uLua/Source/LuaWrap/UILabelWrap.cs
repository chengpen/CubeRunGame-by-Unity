...
public class UILabelWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("customModifier", get_customModifier, set_customModifier),
			...
			new LuaField("overflowWidth", get_overflowWidth, set_overflowWidth),
			...
			new LuaField("modifier", get_modifier, set_modifier),
			new LuaField("printedText", get_printedText, null),
		};
	...
	static int get_customModifier(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name customModifier");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index customModifier on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.customModifier);
		return 1;
	}
	...
	static int get_overflowWidth(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name overflowWidth");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index overflowWidth on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.overflowWidth);
		return 1;
	}
	...
	static int get_modifier(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name modifier");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index modifier on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.modifier);
		return 1;
	}
	...
	static int get_printedText(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name printedText");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index printedText on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.printedText);
		return 1;
	}
	...
	static int set_customModifier(IntPtr L)
	{
		...
		{
			obj.customModifier = (UILabel.ModifierFunc)LuaScriptMgr.GetNetObject(L, 3, typeof(UILabel.ModifierFunc));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.ToLuaFunction(L, 3);
			obj.customModifier = (param0) =>
			{
	...
	static int set_overflowWidth(IntPtr L)
	{
		...
		obj.overflowWidth = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	static int set_modifier(IntPtr L)
	{
		...
		obj.modifier = (UILabel.Modifier)LuaScriptMgr.GetNetObject(L, 3, typeof(UILabel.Modifier));
		return 0;
	}
	...
	static int OnFill(IntPtr L)
	{
		...
		BetterList<Color> arg2 = (BetterList<Color>)LuaScriptMgr.GetNetObject(L, 4, typeof(BetterList<Color>));
